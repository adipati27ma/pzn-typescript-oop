// Polymorphism = berubah bentuk tapi hanya bisa berubah menjadi class turunannya.
// Method Polymorphism = method yg bisa diinput dgn class tersebut atau turunannya.
